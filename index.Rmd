...
1. [R Graph Gallery](https://www.r-graph-gallery.com/), particularly the post on [Bubble maps with ggplot2](Bubble map with ggplot2)
2. [R Vingettes](https://cran.r-project.org/web/packages/ggfortify/vignettes/plot_map.html)
